    ...
    return (
        <div className="min-h-screen" style={{background:"black" , color:"white"}}>
            <div className="container pt-5 d-flex flex-column align-items-center">
                ...
                <p className="text-center border-bottom pb-2 pt-3">Right now i’m in SilverOak University pursuing 5th Semester in B-Tech IT. I would like to implement my Innovative ideas, Skills and Creativity for accomplishing the project. I like to Learn and Adopt new Devlopment Technology. I can provide Clean Code and Pixel Perfect Design. I also make the website more & more Interactive with web Animations. A responsive design makes your website accessible to all users, regardless of their devices. <p className="text-center mt-2">
                                ...
                                <div className="row">
                                    ...
                                    <div className="col-md-6">
                                        ...
                                        <div className="pt-4 pb-4">
                                            ...
                                            <div className="progress rounded">
                                                <div className="progress-bar rounded" role="progressbar" style={{ width: "60%", background:"#286f6f" }} >60%</div>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div className="row">
                                    <div className="col-md-6">
                                        <div className="pb-4">
                                            ...
                                            <div className="progress rounded">
                                                <div className="progress-bar rounded" role="progressbar" style={{ width: "85%", background:"#286f6f" }}>85%</div>
                                            </div>
                                        </div>
                                    </div>
                    ...
                    <div className="col-md-4">
                        <div className="card">
                            <div className="card-body pb-0" style={{background:"black"}}>
                                <h5 className="card-title fw-bold pb-2" style={{color:"white"}}>Soft-Skills</h5>
